...
const { AppleBasket } = require("../singlton.cjs");
const appleBasket = new AppleBasket();
...
const getAllComments = async (req, res) => {
    ...
    const sql = `SELECT content, timestamp, user.username, user.userId, commentId, comment.postId`+
                `FROM comment,
    user
WHERE
    postId = ?
